...
func getSBH(algo, pt, symbols string, nr, seed int64, ut int) SBH {
	return SBH{
		Plaintext:      pt,
		NRots:          nr,
		Seed:           seed,
...
func TestUppercaseTimesSBH(t *testing.T) {
	result := Generate(getSBH("", "test", "", 1729, 42, 3))
	expected := "505C3C3Fab111175642a3073756472621d0312388dec72ee9268c05f96463ecb"
...
func TestMD5SBH(t *testing.T) {
	result := Generate(getSBH("md5", "test", "", 1729, 42, 0))
...
func TestSHA1SBH(t *testing.T) {
	result := Generate(getSBH("sha1", "test", "", 1729, 42, 0))
...
func TestSHA256_224SBH(t *testing.T) {
	result := Generate(getSBH("sha256_224", "test", "", 1729, 42, 0))
...
func TestSHA256SBH(t *testing.T) {
	result := Generate(getSBH("sha256", "test", "", 1729, 42, 0))
	expected := "505c3c3fab111175642a3073756472621d0312388dec72ee9268c05f96463ecb"
...
func TestSHA512_224SBH(t *testing.T) {
	result := Generate(getSBH("sha512_224", "test", "", 1729, 42, 0))
...
func TestSHA512_256SBH(t *testing.T) {
	result := Generate(getSBH("sha512_256", "test", "", 1729, 42, 0))
...
func TestSHA512_384SBH(t *testing.T) {
	result := Generate(getSBH("sha512_384", "test", "", 1729, 42, 0))
...
func TestSHA512SBH(t *testing.T) {
	result := Generate(getSBH("sha512", "test", "", 1729, 42, 0))
...
func benchmarkDefaultSBH(nRots int64, b *testing.B) {
	for i := 0; i < b.N; i++ {
		Generate(getSBH("", "test", "", nRots, 42, 0))
	}
}
